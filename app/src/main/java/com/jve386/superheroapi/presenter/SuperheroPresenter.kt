...
class SuperheroPresenter @Inject constructor(private val repository: SuperheroRepository) :
    SuperheroContract.Presenter {
    ...
    override suspend fun searchSuperheroes(name: String) {
        ...
        repository.searchSuperheroes(
            name,
            object : SuperheroRepository.Callback<SuperHeroDataResponse> {
    ...
    override suspend fun getSuperheroDetail(id: String) {
        ...
        repository.getSuperheroDetail(
            id,
            object : SuperheroRepository.Callback<SuperHeroDetailResponse> {
